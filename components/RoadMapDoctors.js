...
import GPCIcon from '../public/images/serviceassets/gpc.png' // Replace with actual icons
import Vaccinations from '../public/images/serviceassets/vaccination.png' // Replace with actual icons
    ...
    <div className="bg-white pl-6 pt-6 pr-6 pb-6">
      <div className="mx-auto">
        ...
        <SubHeading
          ...
          />
        <p className='pt-3 fade-in'>At BabyMD, we believe healthcare for your tiny star should feel less like a task and more like a trusted hand guiding you — steady, joyful, and full of heart.  That’s why we care for your child holistically, looking beyond symptoms to address the root cause and nurture their overall well-being.</p>
		<p className='pb-8 pt-3 fade-in'>Because babies don’t wait for weekdays, we’re open on Sundays too, so expert care is always within reach when you need it most. Here’s how we walk this journey with you:</p>
