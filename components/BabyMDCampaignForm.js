  ...
  return (
    <>
      ...
      <main className="min-h-screen flex items-center justify-center p-4 md:p-8">
        <div className="w-full max-w-6xl bg-white p-5 md:p-8 relative rounded-lg">
          {/* Header Title */}
          ...
          <div className="bg-[#eaf6ff] rounded-xl p-6 md:p-8 space-y-4 relative mt-8">
            <h2 className="font-semibold text-gray-800 mediumWnn pb-4 md:text-xl">
            ...
            <Image 
              ...
              height={78}
            />
            <div className="text-gray-700 space-y-2 md:text-lg font-sans">
              ...
              <div className="flex items-center gap-2 pb-4">
                <span>
                  <svg width="26" height="14" viewBox="0 0 21 14" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="flex items-center gap-2 pb-4">
                <span>
                  <svg width="26" height="19" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
