...
import clinicIcon from '../../public/images/Icon1.png'
import diagnosticsIcon from '../../public/images/Icon2.png'
...
interface RoadmapSection {
  title: string
  color: string
  icon: any // You can specify `StaticImageData` from 'next/image' for stricter typing
  content: string[]
}
...
const Roadmap: React.FC<RoadmapProps> = ({ onClick }) => {
  ...
  const roadmapData: RoadmapSection[] = [
    ...
    },
    {
      ...
      content: ['Allergy Test', 'Asthma Test', 'PFT', 'All Blood Tests'],
    },
    {
    ...
    },
    {
      ...
      color: 'bg-[#E1556E]',
      icon: therapyIcon,
      content: ['Speech', 'Occupational', 'Behavioural'],
    },
    {
      title: 'Immunisation',
      color: 'bg-[#F96E40]',
      icon: immunisationIcon,
      content: ['HPV and Flu/Influenza Vaccines', 'All mandatory vaccines as per IAP 2025'],
    },
    {
    ...
    <div className="bg-white pl-6 pt-6 pr-6 pb-6">
      <div className="mx-auto">
        <div className="relative">
          ...
          />
          <p className="pb-6 pt-3 fade-in">
            Our BabyMD clinics offer comprehensive paediatric care with a team of doctors, therapists, and specialists.
            From check-ups and vaccinations to speech therapy and allergy management, everything your child needs is
