...
const testimonials = [
  {
    id: 1,
    text: `“I was deeply concerned about our son’s breathing issues, and BabyMD’s pulmonologist was an absolute lifesaver. The doctor took time to explain everything and now we feel much more confident managing his asthma.”
`,
    name: "Aditya,",
