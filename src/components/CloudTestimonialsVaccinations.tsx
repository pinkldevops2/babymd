...
const testimonials = [
  {
    id: 1,
    text: `"It was a very pleasant and non-scary experience, something that's rare in clinics and hospitals. The HPV vaccine was administered with great care to my child, and the next steps were clearly explained. Thank you to the BabyMD team at the Hosa Road branch, and a special shout-out to Dr Bhaskar!"`,
    name: "Saasha",
  ...
  return (
    <div className="bg-[#E1F5FF] text-[#4B3A8F] relative z-2">
      ...
      <h2 className="text-[28px] text-black leading-[32px] font-bold mb-2 px-6 md:px-6 fade-in">
        Heartfelt stories of  <span className="text-[#5943A5]">care and </span>
        <br />
        <span className="text-[#5943A5] italic font-medium relative circling_around2 adjusters">
          <i className="relative z-5">comfort </i>
          <ContactSubC />
        </span>{" "}
