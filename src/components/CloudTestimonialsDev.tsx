...
const testimonials = [
  {
    id: 1,
    text: `“Clinical psychologist Neelam Verma handled our 6-month-old twins very well. She explained the entire developmental assessment process to us and answered all our questions promptly.”`,
    name: "Dhananjay Raj",
    location: "",
    image: keerthana,
  },
