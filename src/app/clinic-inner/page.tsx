 ...
 /*  const [slider1Ref, slider] = useKeenSlider<HTMLDivElement>({
            ...
            <div className="md:w-1/2 p-2">
              ...
              <div className="flex items-start flex-col relative gap-4 mb-6">
                ...
                <div className="w-full pb-6">
                  ...
                  <button className="uppercase mt-4 mx-auto text-white bg-[#F8845D] hover:bg-[#5943A5] transition-all font-medium rounded-full text-sm px-8 py-4 flex items-center gap-2">
                    Get Directions <img src="/images/Group 2349.png" />
                  </button>
                </div>
              </div>
              </div>
              ...
              <div className="flex items-start flex-col gap-4">
                ...
                <div className="w-full pb-6">
                  ...
                  <button className="uppercase mt-4 mx-auto text-white bg-[#F8845D] hover:bg-[#5943A5] transition-all font-medium rounded-full text-sm px-8 py-4 flex items-center gap-2">
                    Talk to us <img src="/images/Group 2349.png" />
                  </button>
                </div>
              </div>
            </div>
  ...
  >
   ...
   {/*    <DoctorSlider /> */}
      ...
      <div className="navigation-wrapper px-4 relative max-w-md mx-auto py-6 bg-white">
        <div className="">
