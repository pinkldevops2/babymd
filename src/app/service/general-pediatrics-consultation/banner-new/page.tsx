...
export default function Banner() {
  return (
    <section>
      <div className="banner-box bg-[white] relative z-2 pt-12 pb-6">
        ...
        <div className="w-full md:w-1/2 relative">
          <h2 className="text-[42px] leading-[40px] font-bold ">
            ...
            <span className="relative inline-block">
              ...
              <Image className="absolute top-[3] right-0 z-0" width={150} height={100} src="/images/solvingcirc.png" alt= 'image1'/>
            </span>
          ...
          <Image className="absolute top-[-40px] right-0" src="/images/Group 427319502.svg" alt= 'image2' width={50} height={50} />
          <Image className="absolute bottom-[-42px] left-0" src="/images/Group 427319515.svg"  alt= 'image3' width={50} height={50} />
          
        </div>

        <div className="w-full md:w-1/2 relative">
          <Image className="mx-auto" src="/images/Vector copy.svg" alt= 'image4'  width={50} height={50}/>
          <Image className="mx-auto absolute top-0 left-1/2 transform -translate-x-1/2" src="/images/doctorbg.png"  alt= 'image' width={50} height={50}/>
        </div>
      </div>
    </div>
    </div>
