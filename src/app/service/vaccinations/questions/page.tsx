          ...
          <div className="w-full md:w-2/3 px-2 py-2 md:p-4 md:pl-12">
            <div className="relative px-4 md:px-0">
              ...
              <p className="text-[#2E2E2E] text-[16px] md:text-lg leading-relaxed mt-4">
                Worried about side effects? Concerned about combination
                vaccines? Or unsure if your child needs catch-up doses? Our
                doctors are here to listen, explain, and guide you — no rushed
                appointments, just real conversations.
              </p>
            </div>
          </div>
