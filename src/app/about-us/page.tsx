...
here to{" "}
                  ...
                  <span className="relative clinic_border relative z-[2]">
                    <i className="font-normal text-[#5943A5] z-2 relative">
                     ...
                     <div className='svg-animation clinic-svg absolute z-[-1] top-[5px]' >
                        <svg className="w-[130px] h-auto rotate-180" width="114" height="38" viewBox="0 0 114 38" fill="none" xmlns="http://www.w3.org/2000/svg">
