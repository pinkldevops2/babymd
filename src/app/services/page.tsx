    ...
    <>
      <div className="container">
            ...
            <div className="flex flex-col justify-center items-center md:flex-row">
              <div className="w-full md:w-2/3">
                <div className="relative px-6 md:px-0 md:w-3/4">
                  ...
                  <p className="">
                    Where check-ups spark giggles, vaccinations come with
                    cuddles, and milestones get the birthday treatment
                  </p>
                  <img
        ...
        <div className="relative w-full bg-[#FFFFFF]">
          <Image src={curvedTop} alt="Layer 1" className=" mx-auto w-full" />
        </div>
        <CloudTestimonials />
