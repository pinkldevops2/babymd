...
import serviceVector from "../../../../../public/images/serviceassets/serviceVector.png";
import serviceVectorimg1 from "../../../../../public/images/serviceassets/DATbannerImg.png";
        ...
        <div className="md:w-1/2">
          ...
          <div className="relative flex items-center">
            <h2 className="text-[34px] leading-[34px] max-w-[400px] font-bold font-baloo2 mt-2">
              When growing up feels different, {" "}
              <span className=" text-[#4B3A8F]">
                we step in with  <i className="relative z-[2] font-light"> 
                  care
                   <div className='absolute z-[-1] left-[-5px] top-1' >
                    <svg
                      viewBox="0 0 137 47"
                      xmlns="http://www.w3.org/2000/svg"
                      className="w-[95px] h-auto overflow-visible relative top-[4px]"
                    >
                      <path
                        ref={pathRef}
            ...
            <Image
              ...
              width={36}
              height={36}
              className="mt-1 ml-2 mb-14 md:mt-0 lg:mt-[-30px] z-10 min-w-[35px]"
              alt="Beehive 2"
            />
          </div>
          <p className=" md:text-base lg:text-lg text-black mt-4 leading-relaxed font-lato">
           Every child finds their rhythm at their own pace. We’re here to walk with them every step of the way with expert care, kind eyes, and playful hearts
