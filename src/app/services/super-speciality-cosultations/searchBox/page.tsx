...
export default function searchBox() {
  ...
  return (   
        ...
        <div className=" bg-white px-6 py-6">
             <h2 className="text-[28px] leading-[28px] font-bold font-baloo2 mt-2 md:text-center">
          The special heroes for your  {" "}
          <span className=" text-[#4B3A8F]">
            ...
            <i className="relative z-[2] font-light whitespace-nowrap">
              special one
               ...
               <div className="max-w-md mt-6 bg-white rounded-[20px] shadow-md p-6 border mx-auto" style={{ borderColor: '#91CFDA80' }}>
              <h2 className="text-lg font-large text-gray-800 font-semibold">
                Browse by <span className="text-[#5943A5]">location</span> and <span className="text-[#5943A5]">Mode</span>
              </h2>
