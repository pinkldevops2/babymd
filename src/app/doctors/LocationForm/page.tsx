...
export default function Locationform() {
  return (
          ...
          <div className="">
            <div className="max-w-md mx-auto bg-white rounded-[20px] shadow-md p-6 border " style={{ borderColor: '#91CFDA80' }}>
                   ...
                   {/*  <select className="w-full mt-4 px-4 py-2 border border-[#91CFDA80] bg-[#F4F4F4] rounded-lg focus:ring-2 focus:ring-purple-500">
                    ...
                    <div className='w-full mt-4 px-4 py-4 border border-[#91CFDA80] bg-[#F4F4F4] rounded-lg flex gap-4 flex-wrap location-select'>
                      <p className='w-full font-bold text-[14px]'>Location</p>
                         ...
                         <label className='text-[#9C7EEB]'>
                          <input type="radio" name="location" value="Hosa Road"/> <span>Hosa Road</span>
                        </label>
                    ...
                    <label className=''>
                      <input type="radio" name="location" value="HSR" /> <span>Varthur</span>
                    </label>
                    
                    <label className=''>
                      <input type="radio" name="location" value="Bellandur" /> <span>Bellandur</span>
                    </label>
                    
                    <label className=''>
                      <input type="radio" name="location" value="HSR" /> <span>Whitefield</span>
                    </label>
                   
                    <label className=''>
                      <input type="radio" name="location" value="HSR" /> <span>Electronic City</span>
                    </label>
       ...
       <SuperDocButton href="https://babymd.in/pp/patient-portal/" label="Book an Appointment" className="w-60 text-center uppercase md:hidden" variant="pink"/>
                        </div>
        </div>
  );
}